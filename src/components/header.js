          ...
          <div className="row">
              ...
              >
                <a href="/" style={{ display: "flex" }}>
                  ...
                  {/* <p
                    ...
                    style={{ paddingLeft: "10px", marginTop: "auto" }}
                  >
                    AVAX Governance
                  </p> */}
                </a>
            ...
            <div className="col-md-5 pr-0 pl-0 col-7" id="infoPool">
              <div className="sc-eilVRo jaXjyZ">
                <div className="sc-eerKOB bKbMab">
                  <span className="sc-jzgbtB dwWyiU"></span>
                  <div className="sc-bnXvFD bcIrBV">
                    <a
                      ...
                      target="_blank"
                      id="connect-wallet"
                      className="sc-gqjmRU gacWOr sc-iAyFgw sc-jWBwVP sc-cMhqgX sc-esOvli iivcTi"
                    >
                      <p className="sc-hMFtBS cxjZDP">Check Audits</p>
                    </a>
                  </div>
